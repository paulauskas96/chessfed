...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/calendar/editor.scss");
...
function Edit() {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Calendar – hello from the editor!', 'calendar'));
}
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/calendar/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/calendar/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/calendar/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/calendar/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_5__.name, {
   ...
   */
  edit: () => {
    const calendarComponentRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useRef)(null);
    const [events, setEvents] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useState)([]);
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_6__.useEffect)(() => {
      fetch("/wp-json/wp/v2/varzybos").then(response => response.json()).then(posts => {
        const events = posts.map(post => {
          const formattedDate = post.acf.varzybu_data.slice(0, 4) + "-" + post.acf.varzybu_data.slice(4, 6) + "-" + post.acf.varzybu_data.slice(6);
          return {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_react__WEBPACK_IMPORTED_MODULE_7__["default"], {
...
function save() {
  ...
  }, 'Calendar – hello from the saved content!');
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/calendar","version":"0.1.0","title":"Calendar","category":"widgets","icon":"smiley","description":"Custom plugin\'as. Kalendorio ir zemelapio gutenebrg block\'ui","example":{},"supports":{"html":false},"textdomain":"calendar","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["calendar/style-index"], function() { return __webpack_require__("./src/calendar/index.js"); })
