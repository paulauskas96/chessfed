...
/* harmony import */ var tippy_js_dist_backdrop_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tippy.js/dist/backdrop.css */ "./node_modules/tippy.js/dist/backdrop.css");
/* harmony import */ var tippy_js_animations_shift_away_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tippy.js/animations/shift-away.css */ "./node_modules/tippy.js/animations/shift-away.css");
...
document.addEventListener("DOMContentLoaded", async function () {
  try {
    ...
    const calendarElement = document.getElementById("calendar");
    const calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_4__.Calendar(calendarElement, {
      ...
      eventDidMount: function (info) {
        const endDate = new Date(info.event.end);
        const formattedEndDate = endDate.toISOString().split("T")[0];
        (0,tippy_js__WEBPACK_IMPORTED_MODULE_6__["default"])(info.el, {
          content: `
						<a href="${info.event.extendedProps.url}" target="_blank">
							<h3 class="turnyro-title underline">${info.event.title}</h3>
						</a>
          ...
          trigger: "click",
          theme: "light-border",
          arrow: tippy_js__WEBPACK_IMPORTED_MODULE_6__.roundArrow,
          interactive: true,
          placement: "auto-start",
          animateFill: true,
          sticky: true,
          plugins: [tippy_js__WEBPACK_IMPORTED_MODULE_6__.sticky, tippy_js__WEBPACK_IMPORTED_MODULE_6__.animateFill],
          popperOptions: {
            strategy: "fixed"
          }
        });
